...
# Конвертируем веса оригинальной модели Stable Diffusion для возможности работы
# Взято отсюда https://github.com/kjsman/stable-diffusion-pytorch/issues/7#issuecomment-1426839447
...
def preload_models_from_standard_weights(ckpt_path, device="cuda"):
